...
import logoSrc from '@/assets/img/test/design.png';
import footerLogo from '@/assets/img/test/logo.png';
import logoSrcF from '@/assets/img/test/logo.png';

export async function pdfAssurance() {
