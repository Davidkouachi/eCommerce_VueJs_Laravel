...
}), positionTopStart && (positionTopStart.onclick = function() {
    Swal.fire({
        position: "top-start",
        icon: "success",
...
}), positionBottomStart && (positionBottomStart.onclick = function() {
    Swal.fire({
...
}), positionBottomEnd && (positionBottomEnd.onclick = function() {
    Swal.fire({
        position: "bottom-end",
        icon: "success",
        text: "Your work has been saved",
